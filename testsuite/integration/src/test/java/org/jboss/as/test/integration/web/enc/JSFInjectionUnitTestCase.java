...
import org.jboss.as.test.integration.web.enc.jsfbean.ENCAnnotationsManagedBean;
import org.jboss.as.test.integration.web.enc.jsfbean.SimpleManagedBean;
...
public class JSFInjectionUnitTestCase {
    ...
    public static EnterpriseArchive deployment() {
        ...
        String ejbLocation = "org/jboss/as/test/integration/web/enc/ejb3";
...
//          </war>
        ...
        war.addAsServiceProvider(ServiceActivator.class, ENCServiceActivator.class);
        war.setManifest(new StringAsset("Dependencies: org.jboss.as.naming,org.jboss.as.server,org.jboss.msc,org.jboss.modules"));
        war.addClass(ENCServiceActivator.class);
        ...
        war.addAsWebResource(tccl.getResource(resourcesLocation + "jsp/enc.jsp"), "enc.jsp");
        war.addAsWebResource(tccl.getResource(resourcesLocation + "jsp/simple.jsp"), "simple.jsp");
...
//          </war>
        ...
        alternateWar.addAsServiceProvider(ServiceActivator.class, ENCServiceActivator.class);
        alternateWar.setManifest(new StringAsset("Dependencies: org.jboss.as.naming,org.jboss.as.server,org.jboss.msc,org.jboss.modules\n"));
        alternateWar.addClass(ENCServiceActivator.class);
        ...
        alternateWar.addClass(ENCTesterFirst.class);
