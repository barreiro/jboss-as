...
public abstract class SSOBaseCase {
    ...
    public static void executeLogout(HttpClient httpConn, String warURL) throws IOException {
    ...
    public static void executeFormLogin(HttpClient httpConn, String warURL) throws IOException {
        // Submit the login form
        ...
        String indexURI = postResponse.getFirstHeader("Location").getValue();
        HttpGet rediretGet = new HttpGet(indexURI);
        ...
        assertTrue("Get of " + indexURI + " redirected to login page", body.indexOf("j_security_check") < 0);
    }
