...
import org.jboss.as.test.integration.web.enc.servlet.StandaloneENCServlet;
...
@RunAsClient
public class EncXmlUnitTestCase {

    private static Logger log = Logger.getLogger(EncXmlUnitTestCase.class);

    protected final String baseURL = "http://localhost:8080/";

    @Deployment(name = "simple-xmlonly.war", testable = false)
    public static WebArchive deployment() {
        ...
        // return getDeploySetup(EncXmlUnitTestCase.class,
        // "simple-mock.beans,simple-xmlonly.war");
        ...
        // 9999);
        // addJNDIbinding(mcc, "java:/MockDS",
...
//         </war>
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "simple-xmlonly.war");
        ...
        war.addClass(StandaloneENCServlet.class);
...
//        }
    ...
    public void testAltRequestInfoServlet() throws Exception {
        testURL(new URL(baseURL + "simple-xmlonly/ENCServlet"));
    }
