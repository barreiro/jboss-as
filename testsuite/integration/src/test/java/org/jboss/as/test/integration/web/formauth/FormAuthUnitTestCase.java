...
public class FormAuthUnitTestCase {
    ...
    public static WebArchive deployment() {
        ...
        war.addAsWebResource(tccl.getResource(resourcesLocation + "users.properties"), "/WEB-INF/classes/form-auth-users.properties");
        war.addAsWebResource(tccl.getResource(resourcesLocation + "roles.properties"), "/WEB-INF/classes/form-auth-roles.properties");
    ...
    private static void createSecurityDomains(ModelControllerClient client) throws Exception {
        ...
        rolesmodule.get(MODULE_OPTIONS).add("usersProperties", "form-auth-users.properties");
        rolesmodule.get(MODULE_OPTIONS).add("rolesProperties", "form-auth-roles.properties");
    ...
    public void testFormAuthException() throws Exception {
        ...
        URL url = new URL(baseURLNoAuth + "form-auth/restricted/SecuredServlet");
        ...
        HttpPost formPost = new HttpPost(baseURLNoAuth + "form-auth/j_security_check");
        formPost.addHeader("Referer", baseURLNoAuth + "form-auth/restricted/login.html");
    ...
    public void testPostDataFormAuth() throws Exception {
        ...
        URL url = new URL(baseURLNoAuth + "form-auth/unsecure_form.html");
        HttpGet httpget = new HttpGet(url.toURI());
        ...
        HttpPost restrictedPost = new HttpPost(baseURLNoAuth + "form-auth/restricted/SecuredPostServlet");
