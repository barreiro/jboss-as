 ...
 * the user. Any role in the expectedUserRoles for which isUserInRole is false
 * is added to the X-ExpectedUserRoles-Errors reply header. If the user has
 * every role from the expectedUserRoles list, the X-ExpectedUserRoles-Errors
...
public class UserInRoleServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 1932671897920323569L;
