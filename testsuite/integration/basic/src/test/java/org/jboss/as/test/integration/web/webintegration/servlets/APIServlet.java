...
/**
 * A servlet that tests use of various servlet API calls that can be affected by
 * the web container integration layer.
 * 
 * @author Scott.Stark@jboss.org
 */
public class APIServlet extends HttpServlet {

    private static final long serialVersionUID = 8436136191226496344L;
    ...
    private void testSessionListener(HttpServletRequest request) throws ServletException {
