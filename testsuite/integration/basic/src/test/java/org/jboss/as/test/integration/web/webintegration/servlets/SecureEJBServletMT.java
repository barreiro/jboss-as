...
/**
 * A servlet that spawns a thread to perform a long running task that interacts
 * with a secure EJB.
 * 
...
public class SecureEJBServletMT extends HttpServlet {
    ...
    private static final long serialVersionUID = -2674757641749064091L;
    ...
    static class Worker implements Runnable {
        ...
        public void run() {
            try {
                ...
                StatelessSession bean = ((StatelessSessionHome) ctx.lookup("java:comp/env/ejb/SecuredEJB")).create();
