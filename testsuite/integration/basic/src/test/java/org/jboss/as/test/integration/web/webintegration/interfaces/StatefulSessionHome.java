...
public interface StatefulSessionHome extends EJBHome {
    public StatefulSession create(String testName) throws RemoteException, CreateException;
     ...
     */
    public StatefulSession createAlt(String testName) throws RemoteException, CreateException;
}
