 ...
 */
public class StatefulSessionBean extends SessionSupport implements SessionSynchronization {
    ...
    public void afterCompletion(boolean isCommited) {
        log.debug("afterCompletion(), isCommited=" + isCommited + ", counter=" + counter + ", counterAtTxStart="
                + counterAtTxStart);
        if (isCommited == false) {
    ...
    public void beforeCompletion() {
        log.debug("beforeCompletion(), counter=" + counter + ", counterAtTxStart=" + counterAtTxStart);
    }
    ...
    public BeanContextInfo getBeanContextInfo() throws java.rmi.RemoteException {
    ...
    public void loopbackTest(EJBObject obj) throws java.rmi.RemoteException {
