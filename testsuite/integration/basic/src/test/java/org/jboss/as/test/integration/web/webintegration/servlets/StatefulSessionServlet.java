...
/**
 * A servlet that accesses a stateful session EJB and stores a handle in the
 * session context to test retrieval of the session from the handle.
 * 
 * @author Scott.Stark@jboss.org
 */
public class StatefulSessionServlet extends HttpServlet {

    private static final long serialVersionUID = -5293252867352081888L;
