...
import static org.jboss.as.ee.resource.definition.ResourceDefinitionAnnotationProcessor.AnnotationElement.asOptionalBoolean;
import static org.jboss.as.ee.resource.definition.ResourceDefinitionAnnotationProcessor.AnnotationElement.asOptionalInt;
import static org.jboss.as.ee.resource.definition.ResourceDefinitionAnnotationProcessor.AnnotationElement.asOptionalString;
import static org.jboss.as.ee.resource.definition.ResourceDefinitionAnnotationProcessor.AnnotationElement.asOptionalStringArray;
import static org.jboss.as.ee.resource.definition.ResourceDefinitionAnnotationProcessor.AnnotationElement.asRequiredString;
...
public class DataSourceDefinitionAnnotationProcessor extends ResourceDefinitionAnnotationProcessor {
    ...
    protected ResourceDefinitionInjectionSource processAnnotation(AnnotationInstance annotationInstance, PropertyReplacer propertyReplacer) throws DeploymentUnitProcessingException {
        ...
        injectionSource.setClassName( asRequiredString( annotationInstance, CLASS_NAME_PROP ) );
        injectionSource.setDatabaseName( asOptionalString( annotationInstance, DATABASE_NAME_PROP ) );
        injectionSource.setDescription( asOptionalString( annotationInstance, DESCRIPTION_PROP ) );
        ...
        injectionSource.setInitialPoolSize( asOptionalInt( annotationInstance, INITIAL_POOL_SIZE_PROP ) );
        injectionSource.setPassword( asOptionalString( annotationInstance, PASSWORD_PROP ) );
        ...
        injectionSource.setServerName( asOptionalString( annotationInstance, SERVER_NAME_PROP ) );
        injectionSource.setTransactional( asOptionalBoolean( annotationInstance, TRANSACTIONAL_PROP ) );
        injectionSource.setUrl( asOptionalString( annotationInstance, URL_PROP ) );
        injectionSource.setUser( asOptionalString( annotationInstance, USER_PROP ) );
