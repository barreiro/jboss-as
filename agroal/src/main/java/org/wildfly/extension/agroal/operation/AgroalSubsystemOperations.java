 ...
 */
public class AgroalSubsystemOperations {

    public static final OperationStepHandler ADD_OPERATION = new AgroalSubsystemAdd();

    public static final OperationStepHandler REMOVE_OPERATION = new AgroalSubsystemRemove();
